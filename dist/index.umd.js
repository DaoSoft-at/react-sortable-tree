(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-dom'), require('react-dnd'), require('lodash.isequal'), require('react-dnd-html5-backend'), require('react-virtualized')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-dom', 'react-dnd', 'lodash.isequal', 'react-dnd-html5-backend', 'react-virtualized'], factory) :
  (global = global || self, factory(global['react-sortable-tree'] = {}, global.React, global.PropTypes, global.ReactDOM, global.ReactDnD, global.isEqual, global.ReactDnDHtml5Backend, global.ReactVirtualized));
}(this, (function (exports, React, PropTypes, reactDom, reactDnd, isEqual, reactDndHtml5Backend, reactVirtualized) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  var reactDom__default = 'default' in reactDom ? reactDom['default'] : reactDom;
  var reactDnd__default = 'default' in reactDnd ? reactDnd['default'] : reactDnd;
    ...
    function (_Component) {
      ...
      _createClass(ScrollingComponent, [{
        ...
        value: function componentDidMount() {
          ...
          this.container = (0, reactDom__default.findDOMNode)(this.wrappedInstance.current);
